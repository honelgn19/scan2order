  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white pb-20">
      <div className="max-w-2xl mx-auto px-4 pt-12 text-center">
        ...
        <p className="text-zinc-400 text-lg">Thank you for ordering at Lumina</p>

        <Card className="mt-10 bg-zinc-900 border-white/10">
          <CardContent className="p-8">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="text-right">
                ...
                <p className="text-3xl font-bold text-amber-500">#{tableNumber}</p>
              </div>
            </div>
        ...
        <div className="mt-10 space-y-4">
          <Button 
            onClick={() => navigate(`/customer/live-tracking?table=${tableNumber}&orderId=${orderId}`)}
