...
export default function CategoryManagement() {
  ...
  const saveCategory = () => {
    ...
    if (isEditModalOpen && selectedCategory) {
      setCategories(prev =>
        prev.map(cat =>
          cat.id === selectedCategory.id ? { ...newCategory, id: selectedCategory.id } as Category : cat
        )
      );
    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <Dialog open={isAddModalOpen || isEditModalOpen} onOpenChange={() => { setIsAddModalOpen(false); setIsEditModalOpen(false); }}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>{isEditModalOpen ? 'Edit Category' : 'Create New Category'}</DialogTitle>
          </DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button onClick={saveCategory} className="bg-amber-600 hover:bg-amber-700">
      ...
      <Dialog open={isDeleteModalOpen} onOpenChange={setIsDeleteModalOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button variant="destructive" onClick={deleteCategory}>Delete Category</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
